export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの OpenACP を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "OpenACP のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'openacp' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "OpenACP ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "OpenACP CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
