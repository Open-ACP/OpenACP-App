export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju OpenACP-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} OpenACP-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'openacp'.",
  ...
  "desktop.menu.help.documentation": "OpenACP Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka OpenACP CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
