export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji OpenACP",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} OpenACP. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'openacp'.",
  ...
  "desktop.menu.help.documentation": "Dokumentacja OpenACP",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego OpenACP CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
