export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af OpenACP",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af OpenACP er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'openacp'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "OpenACP CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
