export const dict = {
  ...
  "desktop.menu.help.documentation": "OpenACP Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of OpenACP",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of OpenACP has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'openacp' command.",
  ...
  "desktop.cli.error.sidecarMissing": "OpenACP CLI binary is missing. Try reinstalling the desktop app.",
