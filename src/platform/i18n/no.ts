export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OpenACP",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OpenACP er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "OpenACP Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "OpenACP CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
