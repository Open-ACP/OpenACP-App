export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من OpenACP",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من OpenACP، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق OpenACP",
  ...
  "desktop.cli.error.sidecarMissing": "ملف OpenACP CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
