export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию OpenACP",
  ...
  "desktop.updater.downloaded.prompt": "Версия OpenACP {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'openacp'.",
  ...
  "desktop.menu.help.documentation": "Документация OpenACP",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл OpenACP CLI. Попробуйте переустановить настольное приложение.",
