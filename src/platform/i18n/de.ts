export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von OpenACP",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von OpenACP wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'openacp' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "OpenACP-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das OpenACP CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
