export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 OpenACP",
  ...
  "desktop.menu.help.documentation": "OpenACP 文件",
  ...
  "desktop.cli.error.sidecarMissing": "OpenACP CLI 執行檔遺失。請嘗試重新安裝桌面應用程式。",
