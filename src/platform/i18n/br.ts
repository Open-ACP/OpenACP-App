export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do OpenACP",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do OpenACP foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do OpenACP",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do OpenACP está ausente. Tente reinstalar o aplicativo de desktop.",
