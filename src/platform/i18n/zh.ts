export const dict = {
  ...
  "desktop.updater.none.message": "你已经在使用最新版本的 OpenACP",
  ...
  "desktop.updater.downloaded.prompt": "已下载 OpenACP {{version}} 版本，是否安装并重启？",
  ...
  "desktop.menu.help.documentation": "OpenACP 文档",
  ...
  "desktop.cli.error.sidecarMissing": "OpenACP CLI 二进制文件缺失。请尝试重新安装桌面应用程序。",
