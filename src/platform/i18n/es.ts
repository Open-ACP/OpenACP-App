export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de OpenACP",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de OpenACP. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de OpenACP",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de OpenACP. Intenta reinstalar la aplicación de escritorio.",
