export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OpenACP",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OpenACP a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'openacp'.",
  ...
  "desktop.menu.help.documentation": "Documentation d'OpenACP",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI OpenACP est manquant. Essayez de réinstaller l'application de bureau.",
