import type { Message, Session, TextPart, UserMessage } from "@openacp/sdk/v2/client"
import { Avatar } from "@openacp/ui/avatar"
import { HoverCard } from "@openacp/ui/hover-card"
import { Icon } from "@openacp/ui/icon"
import { IconButton } from "@openacp/ui/icon-button"
import { MessageNav } from "@openacp/ui/message-nav"
...
const OPENACP_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === OPENACP_PROJECT_ID ? "https://openacp.com/favicon.svg" : props.project.icon?.override
          }
