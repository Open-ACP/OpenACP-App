...
import { base64Encode } from "@openacp/util/encode"
...
import { Session, type Message } from "@openacp/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@openacp/ui/toast"
...
import { retry } from "@openacp/util/retry"
...
import { useTheme, type ColorScheme } from "@openacp/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://openacp.com/desktop-feedback")}
      renderPanel={() =>
