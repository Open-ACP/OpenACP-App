import "@/index.css"
import { I18nProvider } from "@openacp/ui/context"
import { DialogProvider } from "@openacp/ui/context/dialog"
import { FileComponentProvider } from "@openacp/ui/context/file"
import { MarkedProvider } from "@openacp/ui/context/marked"
import { File } from "@openacp/ui/file"
import { Font } from "@openacp/ui/font"
import { Splash } from "@openacp/ui/logo"
import { ThemeProvider } from "@openacp/ui/theme/context"
...
function ConnectionGate(props: ParentProps<{ disableHealthCheck?: boolean }>) {
  ...
  const [startupHealthCheck, healthCheckActions] = createResource(async () => {
    ...
    const minDuration = checkMode() === "blocking" ? 1200 : 0

    try {
      while (Date.now() - start < timeout) {
        const res = await checkServerHealth(http)
        if (res.healthy) {
          // Ensure minimum duration for blocking mode
