import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@openacp/sdk/v2/client"
import { Button } from "@openacp/ui/button"
import { useDialog } from "@openacp/ui/context/dialog"
import { Dialog } from "@openacp/ui/dialog"
import { Icon } from "@openacp/ui/icon"
import { IconButton } from "@openacp/ui/icon-button"
import { List, type ListRef } from "@openacp/ui/list"
import { ProviderIcon } from "@openacp/ui/provider-icon"
import { Spinner } from "@openacp/ui/spinner"
import { TextField } from "@openacp/ui/text-field"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "openacp"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openacpZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.openacpZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.openacpZen.visit.prefix")}
                <Link href="https://openacp.com/zen" tabIndex={-1}>
                  {language.t("provider.connect.openacpZen.visit.link")}
                </Link>
                {language.t("provider.connect.openacpZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
