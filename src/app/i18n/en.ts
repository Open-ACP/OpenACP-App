export const dict = {
  ...
  "dialog.provider.openacp.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.openacp.tagline": "Reliable optimized models",
  "dialog.provider.openacpGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OpenACP",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenACP.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.openacpZen.line1":
    "OpenACP gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.openacpZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.openacpZen.visit.prefix": "Visit ",
  "provider.connect.openacpZen.visit.link": "openacp.com",
  "provider.connect.openacpZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenACP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenACP.",
  ...
  "dialog.plugins.empty": "Plugins configured in openacp.json",
  ...
  "dialog.server.description": "Switch which OpenACP server this app connects to.",
  ...
  "toast.update.description": "A new version of OpenACP ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenACP team",
  ...
  "error.chain.checkConfig": "Check your config (openacp.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenACP does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OpenACP includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the OpenACP server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for OpenACP",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how OpenACP looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OpenACP follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenACP is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenACP launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenACP.",
