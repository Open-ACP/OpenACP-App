export const dict = {
  ...
  "dialog.provider.openacp.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.openacp.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.openacpGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OpenACP",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i OpenACP.",
  ...
  "provider.connect.openacpZen.line1":
    "OpenACP Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.openacpZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.openacpZen.visit.prefix": "Besøg ",
  "provider.connect.openacpZen.visit.link": "openacp.com/zen",
  "provider.connect.openacpZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i OpenACP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i OpenACP.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i openacp.json",
  ...
  "dialog.server.description": "Skift hvilken OpenACP-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af OpenACP ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OpenACP-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (openacp.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OpenACP understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OpenACP inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør OpenACP-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OpenACP",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan OpenACP ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om OpenACP følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan OpenACP er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OpenACP starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OpenACP.",
