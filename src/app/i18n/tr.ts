...
export const dict = {
  ...
  "dialog.provider.openacp.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.openacp.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.openacpGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenACP tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OpenACP'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.openacpZen.line1":
    "OpenACP Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.openacpZen.visit.prefix": "",
  "provider.connect.openacpZen.visit.link": "openacp.com/zen",
  "provider.connect.openacpZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve OpenACP'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OpenACP'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler openacp.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OpenACP sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "OpenACP'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı OpenACP ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (openacp.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: OpenACP henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "OpenACP ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "OpenACP Masaüstü",
  ...
  "settings.desktop.wsl.description": "OpenACP sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "OpenACP'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "OpenACP'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OpenACP'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OpenACP'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OpenACP başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OpenACP'un en son sürümünü kullanıyorsunuz.",
