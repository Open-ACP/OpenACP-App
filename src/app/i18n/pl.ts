export const dict = {
  ...
  "dialog.provider.openacp.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.openacp.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.openacpGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenACP",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenACP.",
  ...
  "provider.connect.openacpZen.line1":
    "OpenACP Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.openacpZen.visit.prefix": "Odwiedź ",
  "provider.connect.openacpZen.visit.link": "openacp.com/zen",
  "provider.connect.openacpZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenACP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenACP.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w openacp.json",
  ...
  "dialog.server.description": "Przełącz serwer OpenACP, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja OpenACP ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenACP",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (openacp.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "OpenACP zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenACP",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenACP na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OpenACP ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenACP.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenACP",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenACP.",
