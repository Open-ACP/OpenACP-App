...
export const dict = {
  ...
  "dialog.provider.openacp.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.openacp.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.openacpGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OpenACP",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i OpenACP.",
  ...
  "provider.connect.openacpZen.line1":
    "OpenACP Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.openacpZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.openacpZen.visit.prefix": "Besøk ",
  "provider.connect.openacpZen.visit.link": "openacp.com/zen",
  "provider.connect.openacpZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OpenACP.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OpenACP.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i openacp.json",
  ...
  "dialog.server.description": "Bytt hvilken OpenACP-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OpenACP ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OpenACP-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (openacp.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OpenACP ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "OpenACP inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør OpenACP-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OpenACP",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OpenACP ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om OpenACP skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan OpenACP er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når OpenACP starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OpenACP.",
